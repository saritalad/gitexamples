...
export class CartsService {
  ...
  url:string="http://localhost:27608/api/Payment"
  url2:string="http://localhost:27608/api/Payment/PaymentDetails"

  url1:string="http://localhost:27608/api/OrderReceipt"
