...
export class RestaurantService {
 ...
 url:string="http://localhost:27608/api/Restaurant"

 url2:string="http://localhost:27608/api/Menu/GetMenusByRestaurant/"

 url3:string="http://localhost:27608/api/Cart"

 url4:string="http://localhost:27608/api/Cart"

 url5:string="http://localhost:27608/api/Order"
